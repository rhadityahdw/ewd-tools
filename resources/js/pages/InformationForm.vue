...
// Data tambahan untuk dropdown lainnya
        ...
        <div class="container mx-auto max-w-6xl py-8 px-4">
            <Card>
                    ...
                    <form @submit.prevent="submit">
                        <div class="space-y-4">
                            ...
                            <div class="sm:grid-cols-[200px, 1fr] grid grid-cols-1 items-start gap-2 p-2 transition-colors sm:items-center sm:gap-3">
                                ...
                                <Input id="borrower_group" v-model="form.borrower_group" type="text" placeholder="Masukan grup usaha" class="text-sm w-full" />
                            ...
                            <div class="sm:grid-cols-[200px, 1fr] grid grid-cols-1 items-start gap-2 p-2 transition-colors sm:items-center sm:gap-3">
                                ...
                                <Input id="collectibility" v-model="form.collectibility" type="number" placeholder="Masukan kolektabilitas" min="1" max="5" class="text-sm w-full" />
                ...
                <CardFooter class="flex justify-end gap-3">
                    ...
                    <Button type="submit" @click="submit" :disabled="isSubmitting" class="bg-[#2E3192] hover:bg-[#232578]">
                        <Link :href="route('forms.facility')">
