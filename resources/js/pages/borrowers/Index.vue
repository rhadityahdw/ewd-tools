            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle class="text-xl md:text-2xl font-bold">Daftar Debitur</CardTitle>
                    ...
                    <CardContent>
                        <div v-if="borrowers.length === 0" class="text-center py-8 text-gray-500">
                            ...
                            <TableBody>
                                <TableRow v-for="borrower in borrowers" :key="borrower.id">
                                    ...
                                    <TableCell class="text-right flex space-x-3 justify-end">
                                        <Link :href="route('borrowers.edit', borrower.id)" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300" title="Edit">
                                        ...
                                        <Link :href="route('borrowers.show', borrower.id)" class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300" title="View">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
